...
- ``SITESEARCH``: [default: '//google.com/search'] search engine to which
...
.. _`Pelican`: //getpelican.com
.. _`Octopress`: //octopress.org
.. _`my personal blog`: //blogs.skicelab.com/maurizio/
.. _`the repository`: //github.com/duilio/pelican-octopress-theme
